generate_input_parameters <- function(n_samples, treatment_names = treatment_names, 
  ...
  mcmc = read_excel("C:/Users/yx18392/Desktop/LATEST results.xlsx", sheet = "MCMC")
  colnames(mcmc) <- c("samples","lhr")
  mcmc$samples <- seq(2, length.out = nrow(mcmc))
  
  treatment_names_hr <- paste("Implant", c("MoP Cem CR_Mob Mod",  "MoP Cem PS_Fix Mod",
                                           "MoP Cem PS_Mob Mod", "MoP Unc CR_Fix Mod",  "MoP Unc CR_Mob Mod",
                                           "MoP Hyb CR_Fix Mod"))
  
  hr_names <- c(paste0("hr_0-3", treatment_names_hr),
                paste0("hr_3-10", treatment_names_hr),
                paste0("hr_>10", treatment_names_hr))
  n_hr <- length(hr_names)
  hr_input <- array(dim = c(n_samples, n_hr), dimnames = list(NULL, hr_names))
  
  hr_input[,"hr_0-3Implant MoP Cem CR_Mob Mod"]<- (mcmc[mcmc$samples >= 120001 & mcmc$samples <= 130000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Cem CR_Mob Mod"]<- (mcmc[mcmc$samples >= 130001 & mcmc$samples <= 140000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Cem CR_Mob Mod"]<- (mcmc[mcmc$samples >= 140001 & mcmc$samples <= 150000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  
  hr_input[,"hr_0-3Implant MoP Cem PS_Fix Mod"]<- (mcmc[mcmc$samples >= 210001 & mcmc$samples <= 220000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Cem PS_Fix Mod"]<- (mcmc[mcmc$samples >= 220001 & mcmc$samples <= 230000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Cem PS_Fix Mod"]<- (mcmc[mcmc$samples >= 230001 & mcmc$samples <= 240000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  
  hr_input[,"hr_0-3Implant MoP Cem PS_Mob Mod"]<- (mcmc[mcmc$samples >= 300001 & mcmc$samples <= 310000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Cem PS_Mob Mod"]<- (mcmc[mcmc$samples >= 310001 & mcmc$samples <= 320000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Cem PS_Mob Mod"]<- (mcmc[mcmc$samples >= 320001 & mcmc$samples <= 330000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  
  hr_input[,"hr_0-3Implant MoP Unc CR_Fix Mod"]<- (mcmc[mcmc$samples >= 60001 & mcmc$samples <= 70000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Unc CR_Fix Mod"]<- (mcmc[mcmc$samples >= 70001 & mcmc$samples <= 80000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Unc CR_Fix Mod"]<- (mcmc[mcmc$samples >= 80001 & mcmc$samples <= 90000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  
  hr_input[,"hr_0-3Implant MoP Unc CR_Mob Mod"]<- (mcmc[mcmc$samples >= 150001 & mcmc$samples <= 160000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Unc CR_Mob Mod"]<- (mcmc[mcmc$samples >= 160001 & mcmc$samples <= 170000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Unc CR_Mob Mod"]<- (mcmc[mcmc$samples >= 170001 & mcmc$samples <= 180000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  
  hr_input[,"hr_0-3Implant MoP Hyb CR_Fix Mod"]<- (mcmc[mcmc$samples >= 90001 & mcmc$samples <= 100000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_3-10Implant MoP Hyb CR_Fix Mod"]<- (mcmc[mcmc$samples >= 100001 & mcmc$samples <= 110000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  hr_input[,"hr_>10Implant MoP Hyb CR_Fix Mod"]<- (mcmc[mcmc$samples >= 110001 & mcmc$samples <= 120000 & (mcmc$samples %% 10 == 1), "lhr"])$lhr
  ...
  if ("log_rate_1st_revision_<3Implant MoP Cem CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Cem CR_Mob Mod"]}                                                                                      
  
  if ("log_rate_1st_revision_<3Implant MoP Cem PS_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem PS_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Cem PS_Fix Mod"]}                           
  
  if ("log_rate_1st_revision_<3Implant MoP Cem PS_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem PS_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Cem PS_Mob Mod"]}                                                                                                                
  
  if ("log_rate_1st_revision_<3Implant MoP Unc CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Unc CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Unc CR_Fix Mod"]}                                                                                                                 
  
  if ("log_rate_1st_revision_<3Implant MoP Unc CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Unc CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Unc CR_Mob Mod"]}                                                                                                              
  
  if ("log_rate_1st_revision_<3Implant MoP Hyb CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_<3Implant MoP Hyb CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_<3Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_0-3Implant MoP Hyb CR_Fix Mod"]}                                                                                                                
  ...
  if ("log_rate_1st_revision_3-10Implant MoP Cem CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Cem CR_Mob Mod"]}                                                                                      
  if ("log_rate_1st_revision_3-10Implant MoP Cem PS_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem PS_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Cem PS_Fix Mod"]}                                                                                      
  if ("log_rate_1st_revision_3-10Implant MoP Cem PS_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem PS_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Cem PS_Mob Mod"]}                                                                                       
  if ("log_rate_1st_revision_3-10Implant MoP Unc CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Unc CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Unc CR_Fix Mod"]}                                                                                      
  if ("log_rate_1st_revision_3-10Implant MoP Unc CR_Mob Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Unc CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Unc CR_Mob Mod"]}                                                                                       
  if ("log_rate_1st_revision_3-10Implant MoP Hyb CR_Fix Mod" %in% colnames(input_parameters)){
    input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Hyb CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_3-10Implant MoP Cem CR_Fix Mod"]+ hr_input[,"hr_3-10Implant MoP Hyb CR_Fix Mod"]}                                                                                      
    ...
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Cem CR_Mob Mod"]}                                                                                       
  #if ("log_rate_1st_revision_>10Implant MoP Cem PS_Fix Mod" %in% colnames(input_parameters)){
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem PS_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Cem PS_Fix Mod"]}                                                                                      
  #if ("log_rate_1st_revision_>10Implant MoP Cem PS_Mob Mod" %in% colnames(input_parameters)){
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem PS_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Cem PS_Mob Mod"]}                                                                                     
  #if ("log_rate_1st_revision_>10Implant MoP Unc CR_Fix Mod" %in% colnames(input_parameters)){
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Unc CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Unc CR_Fix Mod"]}                                                                                        
  #if ("log_rate_1st_revision_>10Implant MoP Unc CR_Mob Mod" %in% colnames(input_parameters)){
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Unc CR_Mob Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Unc CR_Mob Mod"]}                                                                                      
  #if ("log_rate_1st_revision_>10Implant MoP Hyb CR_Fix Mod" %in% colnames(input_parameters)){
    #input_parameters[ , "log_rate_1st_revision_>10Implant MoP Hyb CR_Fix Mod"] <- input_parameters[ , "log_rate_1st_revision_>10Implant MoP Cem CR_Fix Mod"] + hr_input[,"hr_>10Implant MoP Hyb CR_Fix Mod"]}                                                                                       
  ...
  input_parameters[ ,"qalys_State Early revision"] <- input_parameters[ ,"qalys_State middle revision"] <-  #input_parameters[ ,"qalys_State late revision"] <- 
    input_parameters[ ,"qalys_State second revision"] <-
